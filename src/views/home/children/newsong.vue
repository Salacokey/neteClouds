<template>
  <div>
    ...
    <BetterScroll>
      <div class="scroll-content flex" :style="{width:`${this.newsongList.length * 91}vw`}">
        <ul
          ...
          >
            <div class="flex">
              ...
              <div class="flex-1 pt-[2.85vw] ml-[1vw]">
                <h4 class="dark:text-[#e3e5ec] text-[3.5vw] text-[#3E465B]">
                  {{ i.uiElement.mainTitle.title }}
                </h4>
                <p
                  class="dark:text-[#a8aaaf] text-[2.36vw] text-[#79838F]"
                  v-if="i.uiElement.subTitle"
                >
...
export default {
  ...
  created() {
    this.newsongList = this.resource.creatives;
  },
};
</script>
